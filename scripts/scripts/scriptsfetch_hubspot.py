#!/usr/bin/env python3
"""
Trae el pipeline de HubSpot para el equipo MX Sales y genera:
...
# Los IDs se pueden ver en HubSpot > Configuración > Objetos > Negocios > Pipelines.
# ---------------------------------------------------------------------------

OWNER_IDS = {
    "82927304": "Agustín Merli",
    "82927197": "Manon Fabre",
    "92727693": "Rodrigo Salcedo",
    "93266792": "Hernando Chávez",
}
...
def hs_search(object_type, properties, filters, after=None, limit=100):
...
def fetch_all_deals(stage_filter_values, extra_filters=None):
    """Trae todos los deals de los 4 owners que matcheen el filtro de etapa dado."""
    properties = [
...
def current_quarter_bounds(now):
    ...
    if end_month > 12:
        end_month -= 12
        end_year += 1
    # último día del mes de cierre (aprox: primer día del mes siguiente)
    if end_month == 12:
